...
const KPI_ROWS: KpiRowDef[] = [
  ...
  { key: 'show_rate_ex_cancellations',   label: 'Show Rate (Minus Cancellations)', higherIsBetter: true,  format: 'percent'  },
  ...
  { key: 'avg_deal_size',                label: 'Avg. Cash Collected/Closes',      higherIsBetter: true,  format: 'currency' },
